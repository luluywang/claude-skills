...
- [ ] Line 288: Hedging "roughly" with percentage calculations `Medium` (escalated to `High` in context of peer review)
...
- [ ] Lines 204–206: Minor hedging in introductory clause `Low`

**Comment:** "U.S. payment markets are mature, and this severely limits the variation available for studying merchant behavior." The phrase "this severely limits" is slightly stronger than necessary, but acceptable in context.

**Original:**
```
U.S. payment markets are mature, and this severely limits the variation available for studying merchant behavior.
```

**Proposed Revision:**
```
U.S. payment markets are mature, limiting the variation available for studying merchant behavior.
```

**Why better:** Tighter phrasing. "Severely limits" is redundant with the main point.

---

- [ ] Lines 463–465: Apologetic opening to technical correction `Low`

**Comment:** "I apologize for the confusion. I have changed the language..." is polite but unnecessary. A correction doesn't require apology—just restate the accurate claim.

**Original:**
```
I apologize for the confusion. I have changed the language in the main text to clarify that Online Appendix~\ref{subsec:oa-no-passthrough} considers the polar opposite case of no pass-through, as you suggested.
```

**Proposed Revision:**
```
I have clarified that Online Appendix~\ref{subsec:oa-no-passthrough} considers the polar opposite case of no pass-through.
```

**Why better:** Direct correction without apologetic preamble.

---

- [ ] Lines 715–716: Minor throat-clearing in response `Low`

**Comment:** "Thank you for catching this typo. I have fixed the typo to refer to..." has redundant "typo" and thank-you softening.

**Original:**
```
Thank you for catching this typo. I have fixed the typo to refer to the Section on the Discover evidence.
```

**Proposed Revision:**
```
I have corrected the cross-reference to refer to Section \ref{subsec:oa-discover-rewards} (Discover evidence).
```

**Why better:** State the fix directly without politeness framing or redundancy.

---

- [ ] Lines 1341–1342: Hedging on technical approximation `Low`

**Comment:** "The two lines are not perfectly overlapping, but they are very close approximations. At the fee levels observed in the data, the difference is negligible." Acceptable hedging since the comment is about visual representation, but "very close" could be tighter.

**Original:**
```
The two lines are not perfectly overlapping, but they are very close approximations. At the fee levels observed in the data, the difference is negligible.
```

**Proposed Revision:**
```
The lines are very close approximations at observed fee levels; the difference becomes visible only for fees substantially higher than current equilibrium.
```

**Why better:** More direct description of when the approximation holds.
