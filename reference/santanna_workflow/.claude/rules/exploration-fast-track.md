...
3. **Code immediately** -- no plan needed. Must-haves: code runs, results correct, goal documented.
4. **Log progress** -- append 2-3 lines to SESSION_LOG.md as you work
5. **Decision point** -- keep exploring, graduate to production (upgrade to 80/100), or archive
